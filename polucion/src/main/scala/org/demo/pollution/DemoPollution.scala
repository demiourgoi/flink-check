...
class DemoPollution extends Specification
  ...
  def checkGenPol = {
    ...
    val noPolUntilPol: Formula[List[U]] = noPollution until pollution on numWindows
    val polUntilNoPol: Formula[List[U]] = pollution until noPollution on numWindows
  ...
  def alarmOn = {
    ...
    val noPolUntilPol : Formula[List[U]] =  noPol until pol on numWindows
    ...
    val noAlarmUntilAlarm : Formula[List[U]] = alarm_off until alarm_on on numWindows
  ...
  def noPolReleasePol = {
    ...
    val formula : Formula[List[U]] = pol release noPol on numWindows
